...
parameters = pd.read_csv('/data-fast/james/hms-eeg/seizure-type-classification-tuh/data_preparation/parameters.csv', index_col=['parameter'])
    ...
    for seizure_type, seizures in data_dict.items():
        for seizure in seizures:
            ...
            try:
                ...
                temp = seizure_type_data(patient_id=seizure.segment_id, seizure_type=seizure_type, data=data)
...
def main():
    ...
    default_base_dir = '/data-fast/james/hms-eeg/datasets/tuh_eeg_seizure/edf'
    default_save_dir = '/data-fast/james/hms-eeg/datasets/tuh_eeg_seizure/edf/processed_data'  # Adjust this to your save directory
